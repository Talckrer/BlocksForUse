...
public class BlocksForUse {
    ...
    public void load(FMLInitializationEvent event){
		LanguageRegistry.instance().addStringLocalization("itemGroup.tabDiscs", "en_US", "Disks Tab");
		LanguageRegistry.instance().addStringLocalization("itemGroup.tabBFUThings", "en_US", "Bfu Things Tab");
        Blocks.init();
        Blocks.addNames();
